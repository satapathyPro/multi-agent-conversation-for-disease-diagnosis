...
This project is actively maintained by Subham Satapathy, a Software Engineer with extensive experience in building cloud-scale distributed systems and developing agentic AI automation, including LLM-orchestrated workflows. Subham's expertise spans Python, Scala, Java, and various AI/ML frameworks like Pytorch and Tensorflow, with a strong focus on robust architecture and production-ready systems.
